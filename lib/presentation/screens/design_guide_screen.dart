...
import '../widgets/common/parameter_card.dart';
import '../widgets/common/primary_button.dart';
import '../widgets/common/scenario_card.dart';
...
import '../widgets/specific/code_copy_card.dart';
import '../widgets/specific/feedback/generating_progress.dart';
import '../widgets/specific/feedback/heart_spinner.dart';
import '../widgets/specific/feedback/pulsating_dot.dart';
import '../widgets/specific/feedback/skeleton_ui.dart';
...
import '../widgets/specific/forms/custom_slider.dart';
...
class _DesignGuideScreenState extends State<DesignGuideScreen> {
  ...
  Widget _buildGeneratingProgressDemo() {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: AppColors.surface,
...
class TypographyCard extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 기존 텍스트 스타일 예시
          Text("뭐라고 말할지 모르겠을 때?", style: AppTextStyles.questionTitle),
          const SizedBox(height: 8),
          Text("AI 메시지 만들기", style: AppTextStyles.h1),
          const SizedBox(height: 8),
          Text("썸남한테 보낼 메시지", style: AppTextStyles.h2),
          const SizedBox(height: 8),
          Text("상황이랑 말투만 골라! LIA가 다 해줄게 😎", style: AppTextStyles.subtitle),
          const SizedBox(height: 16),
          Container(
          ...
          const SizedBox(height: 8),
          Text("어떤 메시지가 제일 좋아?", style: AppTextStyles.accessibleHelper),
          const SizedBox(height: 16),
  ...
  Widget _buildFontConsistencyDemo() {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
...
class _TextFieldsCardState extends State<TextFieldsCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const FloatingLabelTextField(label: "썸타는 사람 이름 알려줘!"),
          const SizedBox(height: 16),
          const TagInputField(),
          const SizedBox(height: 20),
...
class GamificationWidgetsCard extends StatelessWidget {
  ...
  /// 개별 배지를 생성하는 메서드입니다.
  Widget _buildBadge(IconData icon, String title, String description) {
    return Column(
      children: [
        Container(
          width: 60,
          ...
          ParameterCard(
            ...
            parameters: [
              ...
              ParameterInfo(
                ...
                example: 'onTabChanged: (index) => print("Tab \$index")',
              ),
              ParameterInfo(
